    ...
    <div class="container bg-warning border border-dark shadow p-5 mb-5 rounded">
         ...
         <form method = "post" action = "{{route('form.update')}}" enctype="multipart/form-data">
            ...
            <div class="form-outline mb-3">
             ...
             <div class="form-outline mb-3"> 
                ...
                <input type="text" class="form-control" id="userName"
                    placeholder="Enter your user_name" name = "username" value = "{{$user->username}}">
                    <br>
                    <small id="showErrorName" class="text-danger">
                        @error('username')
                        {{$message}}
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="userEmail" aria-describedby="emailHelp" name = "email" value = "{{$user->email}}"
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="userMobile" placeholder="000-000-0000" name = "contact" value = "{{$user->userDetail->contact}}">
                <br>
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control" id="userDob" name ="dob" value= "{{$user->userDetail->dob}}">
                <br>
            ...
            <div class="mb-3">
                ...
                <input class="form-control" type="file" id="formFile" name = "profile" value = "{{$user->userDetail->image}}">
                <br>
            ...
            <div class="container">
                ...
                <div class="form-check">
                    <input class="form-check-input userGender" type="radio" name="gender" id="male" value = "male" {{ $user->userDetail->gender == 'male' ? 'checked' : '' }} />
                    <label class="form-check-label" for="male">Male</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input userGender" type="radio" name="gender" id="female" value = "female" {{ $user->userDetail->gender  == 'female' ? 'checked' : '' }} />
            ...
            <div class="container">
                ...
                @foreach ($user->courses as $course)
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="courses[]" value="{{ $course->id }}" {{ $user->courses->contains($course) ? 'checked' : '' }} />
                        <label class="form-check-label" for="flexCheckDefault">{{ $course->course}}</label>
                    </div>
                @endforeach
                
                @foreach ($allCourses as $course)
                @unless ($user->courses->contains($course))
                    <div class="form-check">
            ...
            <div class="btn-group mx-3 mb-3 ">
                <select class="border border-dark rounded p-1 bg-primary cities" aria-label="Default select example" id ="city" name ="city" >
                    ...
                    <option value="haridwar" {{ $user->userDetail->city == 'haridwar' ? 'selected' : '' }}>Haridwar</option>
                    <option value="roorkee"{{ $user->userDetail->city == 'roorkee' ? 'selected' : '' }}>Roorkee</option>
                    <option value="meerut"{{ $user->userDetail->city == 'meerut' ? 'selected' : '' }}>Meerut</option>
